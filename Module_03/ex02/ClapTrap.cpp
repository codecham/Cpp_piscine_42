...
/*   Updated: 2023/02/12 21:38:03 by dcorenti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	std::cout << "Default constructor of " << GREEN << "ClapTrap" << RESET << " called" << std::endl;
	this->_name = "Unknow";
	this->_hit_point = 10;
...
{
	std::cout << "Constructor of " << GREEN << "ClapTrap" << RESET << " with name called" << std::endl;
	this->_name = name;
	this->_hit_point = 10;
	this->_energy_point = 10;
	this->_attack_damage = 10;
...
{
	std::cout << "Copy constructor of " << GREEN << "ClapTrap" << RESET << " called" << std::endl;
...
ClapTrap::~ClapTrap()
{
	std::cout << "Destructor of " << GREEN << "ClapTrap" << RESET << " called" << std::endl;
}

ClapTrap&	ClapTrap::operator=(const ClapTrap& copy)
{
	std::cout << "Operator of " << GREEN << "ClapTrap" << RESET << " '=' called" << std::endl;
	this->_name = copy._name;
	this->_hit_point = copy._hit_point;
	this->_energy_point = copy._energy_point;
	this->_attack_damage = copy._attack_damage;
